...
- (void) processImage:(UIImage *)image {
    ...
    switch ([[UIDevice currentDevice] orientation]) {
        ...
        case UIDeviceOrientationLandscapeRight:
            croppedImage = [[[UIImage alloc] initWithCGImage: imageRef
            scale: 1.0 orientation: UIImageOrientationRight] autorelease];
            break;
            
        case UIDeviceOrientationFaceUp:
            croppedImage = [[[UIImage alloc] initWithCGImage: imageRef
            scale: 1.0 orientation: UIImageOrientationUp] autorelease];
            break;
        
        case UIDeviceOrientationPortraitUpsideDown:
            croppedImage = [[[UIImage alloc] initWithCGImage: imageRef
            scale: 1.0 orientation: UIImageOrientationDown] autorelease];
            break;
...
- (IBAction)retakePhoto:(id)sender{
    [_photoCaptureButton setEnabled:true];
    _captureImage.image = nil;
    _imagePreview.hidden = false;
