...
- (void)setUserInterface
{
    ...
    [_radiusSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/radius", [self class]]] forState:UIControlStateNormal];
    [_radiusSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/radius", [self class]]] forState:UIControlStateHighlighted];
    
    [_radiusSlider setMinimumTrackTintColor:[UIColor greenColor]];
    ...
    [_intensitySlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/intensity", [self class]]] forState:UIControlStateNormal];
    [_intensitySlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/intensity", [self class]]] forState:UIControlStateHighlighted];
    
    [_intensitySlider setMinimumTrackTintColor:[UIColor purpleColor]];
