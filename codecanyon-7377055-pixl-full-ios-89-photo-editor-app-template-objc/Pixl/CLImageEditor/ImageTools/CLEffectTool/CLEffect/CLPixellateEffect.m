...
- (void)setUserInterface
{
    ...
    [_radiusSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/radius.png", [self class]]] forState:UIControlStateNormal];
    [_radiusSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/radius.png", [self class]]] forState:UIControlStateHighlighted];
    
    [_radiusSlider setMinimumTrackTintColor:[UIColor purpleColor]];
}
